...
const Home = () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(893)]).then(__webpack_require__.bind(__webpack_require__, 2641));
const Post = () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(62)]).then(__webpack_require__.bind(__webpack_require__, 4394));
...
class PostsCounterService {
  ...
  async getNewPostsCount(category) {
    const {
      data: {
        rows: newPosts
      }
    } = await this.postService.fetchPosts(1, category);
...
/* harmony export */   K8: () => (/* binding */ randomRgb),
/* harmony export */   R0: () => (/* binding */ toggleBodyScroll),
/* harmony export */   _v: () => (/* binding */ sleep),
/* harmony export */   ow: () => (/* binding */ getPostContent)
/* harmony export */ });
/* unused harmony exports document, replaceTagWithInnerText */
/* harmony import */ var xss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4644);
...
const getPostContent = (data, lang) => {
  if (!data.value?.[lang] && lang !== 'uk') {
    return null;
  }
  const result = xss__WEBPACK_IMPORTED_MODULE_0___default()(data.value?.[lang] || data.value.content);
  const text = replaceTagWithInnerText(result, 'tg-emoji');
  return text;
};
...
/******/ 			return "js/" + (chunkId === 64 ? "chunk-common" : chunkId) + "." + {"62":"810c5e67","64":"98c0f13f","190":"024220ec","418":"be764216","771":"b08ff39f","857":"473562c8","893":"4cf2ef4e"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "css/" + chunkId + "." + {"62":"f1880555","190":"5b84e20a","418":"cb40d4fc","771":"f600840c","857":"e2777194","893":"33a5b18b"}[chunkId] + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			var cssChunks = {"62":1,"190":1,"418":1,"771":1,"857":1,"893":1};
...
/******/ })()
;
//# sourceMappingURL=app.774bf662.js.map