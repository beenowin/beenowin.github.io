...
const fetchPosts = async page => axios_default().post(`${constants/* VUE_APP_API_HOST */.M}/api/posts-list`, {
  data: {
    channels: Object.values(await getChannels()),
    // timestamps: Date.now(),
    pageSize: limit,
    page
  }
...
/******/ })()
;
//# sourceMappingURL=app.f3b00fef.js.map